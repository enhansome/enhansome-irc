...
* [![LimeChat-icon](https://user-images.githubusercontent.com/15098724/56875043-04cca280-69f3-11e9-8e1f-285e54784fe4.png) LimeChat](http://limechat.net/mac/) - One window for multiple servers, keyboard shortcuts, fast & stable. ([source](https://github.com/psychs/limechat) ⭐ 1,583 | 🐛 198 | 🌐 Objective-C | 📅 2021-11-22) `macOS` `iOS`
...
* [![TheLounge-icon](https://user-images.githubusercontent.com/15098724/56899491-6b2fe000-6a48-11e9-9f01-1ed2cfb86b09.png) TheLounge](https://thelounge.chat) - Responsive, self-hosted & support for multiple users. ([source](https://github.com/thelounge/thelounge) ⭐ 6,339 | 🐛 315 | 🌐 TypeScript | 📅 2026-09-24, [demo](https://demo.thelounge.chat/)) `JavaScript` `Node.js` `Web`
* [![WeeChat-icon](https://user-images.githubusercontent.com/15098724/56876389-e028f880-69fb-11e9-82d6-8084e17f2f04.png) WeeChat](https://weechat.org) - A fast, light and extensible chat client. ([source](https://github.com/weechat/weechat) ⭐ 3,394 | 🐛 439 | 🌐 C | 📅 2026-09-25) `Linux` `macOS`
...
* [Ergo](https://ergo.chat/) - Modern server that's portable and designed around specifications (bleeding-edge IRCv3 support). ([source](https://github.com/ergochat/ergo) ⭐ 3,334 | 🐛 206 | 🌐 Go | 📅 2026-09-01)
...
* [wayback](https://github.com/wabarc/wayback) ⭐ 2,233 | 🐛 64 | 🌐 Go | 📅 2026-09-07 - An archiving tool with an IRC interface integrated with various archiving services.
...
* [CloudBot](https://github.com/TotallyNotRobots/CloudBot) ⭐ 182 | 🐛 21 | 🌐 Python | 📅 2026-09-24 - Simple, fast, expandable. `Python`
...
* [Dis4IRC](https://github.com/zachbr/Dis4IRC) ⭐ 119 | 🐛 21 | 🌐 Kotlin | 📅 2026-09-24 - Discord ↔ IRC. `Kotlin`
