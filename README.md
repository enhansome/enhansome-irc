...
* [![KvIRC-icon](https://user-images.githubusercontent.com/15098724/56874636-1d878900-69f0-11e9-856e-719c4c822e25.png) KvIRC](https://www.kvirc.net) - Free, portable, based on Qt GUI toolkit. ([source](https://github.com/kvirc/KVIrc) ⭐ 304 | 🐛 215 | 🌐 C++ | 📅 2026-06-13) `Linux` `macOS` `Windows`
* [ObsidianIRC](https://hello.obby.world/) - Modern WebSocket IRC client with Discord-like UI. ([source](https://github.com/obbyworld/obby) ⭐ 233 | 🐛 50 | 🌐 TypeScript | 📅 2026-09-14) `Linux` `Windows` `macOS` `Android` `iOS` `Web`
...
* [MERK](https://github.com/nutjob-laboratories/merk) ⭐ 74 | 🐛 0 | 🌐 Python | 📅 2026-09-21 - Open source, multiple-document interface GUI client with a rich plugin framework supporting 40+ events; plugins created directly inside the app. `Windows` `macOS` `Linux` `Python`
...
* [![IRCCloud-icon](https://user-images.githubusercontent.com/15098724/56879253-ba581f80-6a0c-11e9-8f6b-8461c10ed149.png) IRCCloud](https://www.irccloud.com) - Group chat for teams, friends, and communities. stay connected, chat from anywhere, and never miss a message (+client) (£0-£3.50/month).
  ...
  * [iOS App](https://github.com/irccloud/ios) ⭐ 300 | 🐛 24 | 🌐 Objective-C | 📅 2026-09-18 - Official. `Objective-C`
  * [Nimbus](https://github.com/jnordberg/irccloudapp) ⭐ 152 | 🐛 5 | 🌐 Objective-C | 📅 2016-12-17 - Standalone client. `macOS` `Objective-C`

### Self-hosted

* [![TheLounge-icon](https://user-images.githubusercontent.com/15098724/56899491-6b2fe000-6a48-11e9-9f01-1ed2cfb86b09.png) TheLounge](https://thelounge.chat) - Responsive, self-hosted & support for multiple users. ([source](https://github.com/thelounge/thelounge) ⭐ 6,336 | 🐛 314 | 🌐 TypeScript | 📅 2026-09-21, [demo](https://demo.thelounge.chat/)) `JavaScript` `Node.js` `Web`
* [![WeeChat-icon](https://user-images.githubusercontent.com/15098724/56876389-e028f880-69fb-11e9-82d6-8084e17f2f04.png) WeeChat](https://weechat.org) - A fast, light and extensible chat client. ([source](https://github.com/weechat/weechat) ⭐ 3,392 | 🐛 439 | 🌐 C | 📅 2026-09-20) `Linux` `macOS`
* [![ZNC-icon](https://user-images.githubusercontent.com/15098724/56879721-d8268400-6a0e-11e9-8b74-c2c748d15c4a.png) ZNC](https://wiki.znc.in/ZNC) - Most popular. many different plugins. ([source](https://github.com/znc/znc) ⭐ 2,125 | 🐛 385 | 🌐 C++ | 📅 2026-09-22) `C++`
* [![Convos-icon](https://user-images.githubusercontent.com/15098724/56879497-d8724f80-6a0d-11e9-844d-7a5380b4524b.png) Convos](https://convos.chat) - Always online web IRC client. ([source](https://github.com/convos-chat/convos) ⭐ 1,192 | 🐛 61 | 🌐 Go | 📅 2026-09-22) `Perl` `JavaScript` `Web`
...
* [Ergo](https://ergo.chat/) - Modern server that's portable and designed around specifications (bleeding-edge IRCv3 support). ([source](https://github.com/ergochat/ergo) ⭐ 3,332 | 🐛 205 | 🌐 Go | 📅 2026-09-01)
* [InspIRCd](https://www.inspircd.org) - Modular, stable, written from scratch. ([source](https://github.com/inspircd/inspircd) ⭐ 1,347 | 🐛 112 | 🌐 C++ | 📅 2026-09-21)
...
* [UnrealIRCd](https://www.unrealircd.org) - Modular, advanced IRCd serving thousands of networks since 1999. ([source](https://github.com/unrealircd/unrealircd) ⭐ 521 | 🐛 4 | 🌐 C | 📅 2026-09-19)
* [miniircd](https://github.com/jrosdahl/miniircd) ⭐ 452 | 🐛 5 | 🌐 Python | 📅 2025-02-12 - Very simple and limited.
...
* [anope](https://www.anope.org) - Designed for flexibility and ease of use. ([source](https://github.com/anope/anope) ⭐ 365 | 🐛 47 | 🌐 C++ | 📅 2026-09-21)

## Bots

*IRC users which provide services for humans, e.g. integrations or information.*

* [wayback](https://github.com/wabarc/wayback) ⭐ 2,232 | 🐛 63 | 🌐 Go | 📅 2026-09-07 - An archiving tool with an IRC interface integrated with various archiving services.
* [Sopel](https://sopel.chat) - Tonnes of ready made features, tutorial, fully documented. ([source](https://github.com/sopel-irc/sopel) ⭐ 982 | 🐛 167 | 🌐 Python | 📅 2026-09-17) `Python`
* [Limnoria](https://github.com/ProgVal/Limnoria) ⭐ 671 | 🐛 248 | 🌐 Python | 📅 2026-09-20 - Robust, user friendly, developer friendly. `Python`
* [Eggdrop](https://www.eggheads.org) - Oldest IRC bot still in active development. Feature rich, uses Tcl scripting. ([source](https://github.com/eggheads/eggdrop) ⭐ 582 | 🐛 256 | 🌐 C | 📅 2026-09-20) `C`
...
* [CloudBot](https://github.com/TotallyNotRobots/CloudBot) ⭐ 182 | 🐛 24 | 🌐 Python | 📅 2026-09-22 - Simple, fast, expandable. `Python`
...
* [milla](https://github.com/terminaldweller/milla) ⭐ 18 | 🐛 2 | 🌐 Go | 📅 2026-05-22 - New generation LLM-powered bot with lua scripting support. `Go`
...
* [matterbridge](https://github.com/42wim/matterbridge) ⭐ 7,568 | 🐛 337 | 🌐 Go | 📅 2024-12-12 - IRC ↔ Mattermost ↔ Discord ↔ XMPP ↔ Gitter ↔ Slack ↔ Discord ↔ Telegram ↔ etc. `Go`
...
* [matterircd](https://github.com/42wim/matterircd) ⭐ 307 | 🐛 4 | 🌐 Go | 📅 2026-09-22 - Matterbridge ↔ IRC, Slack ↔ IRC, Mastodon ↔ IRC. `Go`
...
* [Dis4IRC](https://github.com/zachbr/Dis4IRC) ⭐ 119 | 🐛 21 | 🌐 Kotlin | 📅 2026-09-20 - Discord ↔ IRC. `Kotlin`
...
* [img2src](https://github.com/waveplate/img2irc) ⭐ 46 | 🐛 1 | 🌐 Rust | 📅 2026-09-18 - Convert images to halfblock ANSI or IRC, with a bunch of post-processing filters. `Rust`
