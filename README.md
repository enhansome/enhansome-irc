...
* [![WeeChat-icon](https://user-images.githubusercontent.com/15098724/56876389-e028f880-69fb-11e9-82d6-8084e17f2f04.png) WeeChat](https://weechat.org) - A fast, light and extensible chat client. ([source](https://github.com/weechat/weechat) ⭐ 3,383 | 🐛 439 | 🌐 C | 📅 2026-09-11) `Linux` `macOS`
...
* [Ergo](https://ergo.chat/) - Modern server that's portable and designed around specifications (bleeding-edge IRCv3 support). ([source](https://github.com/ergochat/ergo) ⭐ 3,327 | 🐛 202 | 🌐 Go | 📅 2026-09-01)
...
* [ngIRCd](https://ngircd.barton.de) - Portable and lightweight for small or private networks. ([source](https://github.com/ngircd/ngircd) ⭐ 577 | 🐛 33 | 🌐 C | 📅 2026-07-12)
...
* [geordi](https://github.com/Eelis/geordi) ⭐ 181 | 🐛 2 | 🌐 Haskell | 📅 2022-10-05 - Compiles and runs C++ code snippets. `C++`
