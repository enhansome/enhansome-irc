...
* [![Convos-icon](https://user-images.githubusercontent.com/15098724/56879497-d8724f80-6a0d-11e9-844d-7a5380b4524b.png) Convos](https://convos.chat) - Always online web IRC client. ([source](https://github.com/convos-chat/convos) ⭐ 1,190 | 🐛 56 | 🌐 Go | 📅 2026-08-25) `Perl` `JavaScript` `Web`
...
* [InspIRCd](https://www.inspircd.org) - Modular, stable, written from scratch. ([source](https://github.com/inspircd/inspircd) ⭐ 1,341 | 🐛 112 | 🌐 C++ | 📅 2026-08-25)
...
* [matterircd](https://github.com/42wim/matterircd) ⭐ 307 | 🐛 6 | 🌐 Go | 📅 2026-08-26 - Matterbridge ↔ IRC, Slack ↔ IRC, Mastodon ↔ IRC. `Go`
