...
* [ObsidianIRC](https://hello.obby.world/) - Modern WebSocket IRC client with Discord-like UI. ([source](https://github.com/obbyworld/obby) ⭐ 228 | 🐛 53 | 🌐 TypeScript | 📅 2026-08-24) `Linux` `Windows` `macOS` `Android` `iOS` `Web`
...
* [![TheLounge-icon](https://user-images.githubusercontent.com/15098724/56899491-6b2fe000-6a48-11e9-9f01-1ed2cfb86b09.png) TheLounge](https://thelounge.chat) - Responsive, self-hosted & support for multiple users. ([source](https://github.com/thelounge/thelounge) ⭐ 6,316 | 🐛 316 | 🌐 TypeScript | 📅 2026-08-26, [demo](https://demo.thelounge.chat/)) `JavaScript` `Node.js` `Web`
* [![WeeChat-icon](https://user-images.githubusercontent.com/15098724/56876389-e028f880-69fb-11e9-82d6-8084e17f2f04.png) WeeChat](https://weechat.org) - A fast, light and extensible chat client. ([source](https://github.com/weechat/weechat) ⭐ 3,372 | 🐛 439 | 🌐 C | 📅 2026-08-28) `Linux` `macOS`
...
* [![Convos-icon](https://user-images.githubusercontent.com/15098724/56879497-d8724f80-6a0d-11e9-844d-7a5380b4524b.png) Convos](https://convos.chat) - Always online web IRC client. ([source](https://github.com/convos-chat/convos) ⭐ 1,191 | 🐛 57 | 🌐 Go | 📅 2026-08-30) `Perl` `JavaScript` `Web`
...
* [UnrealIRCd](https://www.unrealircd.org) - Modular, advanced IRCd serving thousands of networks since 1999. ([source](https://github.com/unrealircd/unrealircd) ⭐ 522 | 🐛 4 | 🌐 C | 📅 2026-08-29)
...
* [anope](https://www.anope.org) - Designed for flexibility and ease of use. ([source](https://github.com/anope/anope) ⭐ 363 | 🐛 49 | 🌐 C++ | 📅 2026-08-29)
...
* [matterbridge](https://github.com/42wim/matterbridge) ⭐ 7,552 | 🐛 342 | 🌐 Go | 📅 2024-12-12 - IRC ↔ Mattermost ↔ Discord ↔ XMPP ↔ Gitter ↔ Slack ↔ Discord ↔ Telegram ↔ etc. `Go`
...
* [irc-slack](https://github.com/insomniacslk/irc-slack) ⭐ 205 | 🐛 24 | 🌐 Go | 📅 2026-08-24 - Slack ↔ IRC. `Go`
