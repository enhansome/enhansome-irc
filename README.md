...
* [MERK](https://github.com/nutjob-laboratories/merk) ⭐ 74 | 🐛 0 | 🌐 Python | 📅 2026-09-20 - Open source, multiple-document interface GUI client with a rich plugin framework supporting 40+ events; plugins created directly inside the app. `Windows` `macOS` `Linux` `Python`
...
* [![Convos-icon](https://user-images.githubusercontent.com/15098724/56879497-d8724f80-6a0d-11e9-844d-7a5380b4524b.png) Convos](https://convos.chat) - Always online web IRC client. ([source](https://github.com/convos-chat/convos) ⭐ 1,192 | 🐛 61 | 🌐 Go | 📅 2026-09-19) `Perl` `JavaScript` `Web`
...
* [Ergo](https://ergo.chat/) - Modern server that's portable and designed around specifications (bleeding-edge IRCv3 support). ([source](https://github.com/ergochat/ergo) ⭐ 3,330 | 🐛 206 | 🌐 Go | 📅 2026-09-01)
...
* [Limnoria](https://github.com/ProgVal/Limnoria) ⭐ 671 | 🐛 248 | 🌐 Python | 📅 2026-09-19 - Robust, user friendly, developer friendly. `Python`
...
* [CloudBot](https://github.com/TotallyNotRobots/CloudBot) ⭐ 182 | 🐛 24 | 🌐 Python | 📅 2026-09-19 - Simple, fast, expandable. `Python`
...
* [matterircd](https://github.com/42wim/matterircd) ⭐ 307 | 🐛 5 | 🌐 Go | 📅 2026-09-19 - Matterbridge ↔ IRC, Slack ↔ IRC, Mastodon ↔ IRC. `Go`
...
* [IRCv3 Working Group](https://ircv3.net) - A group of IRC software authors working to enhance, improve, maintain and standardize the IRC protocol. ([source](https://github.com/ircv3/ircv3.github.io) ⭐ 103 | 🐛 18 | 🌐 HTML | 📅 2026-08-07)
