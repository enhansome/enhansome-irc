...
* [![TheLounge-icon](https://user-images.githubusercontent.com/15098724/56899491-6b2fe000-6a48-11e9-9f01-1ed2cfb86b09.png) TheLounge](https://thelounge.chat) - Responsive, self-hosted & support for multiple users. ([source](https://github.com/thelounge/thelounge) ⭐ 6,313 | 🐛 315 | 🌐 TypeScript | 📅 2026-08-18, [demo](https://demo.thelounge.chat/)) `JavaScript` `Node.js` `Web`
* [![WeeChat-icon](https://user-images.githubusercontent.com/15098724/56876389-e028f880-69fb-11e9-82d6-8084e17f2f04.png) WeeChat](https://weechat.org) - A fast, light and extensible chat client. ([source](https://github.com/weechat/weechat) ⭐ 3,368 | 🐛 441 | 🌐 C | 📅 2026-08-17) `Linux` `macOS`
...
* [CloudBot](https://github.com/TotallyNotRobots/CloudBot) ⭐ 182 | 🐛 23 | 🌐 Python | 📅 2026-08-18 - Simple, fast, expandable. `Python`
