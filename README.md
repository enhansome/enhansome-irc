...
* [MERK](https://github.com/nutjob-laboratories/merk) ⭐ 74 | 🐛 0 | 🌐 Python | 📅 2026-09-05 - Open source, multiple-document interface GUI client with a rich plugin framework supporting 40+ events; plugins created directly inside the app. `Windows` `macOS` `Linux` `Python`
...
* [![TheLounge-icon](https://user-images.githubusercontent.com/15098724/56899491-6b2fe000-6a48-11e9-9f01-1ed2cfb86b09.png) TheLounge](https://thelounge.chat) - Responsive, self-hosted & support for multiple users. ([source](https://github.com/thelounge/thelounge) ⭐ 6,322 | 🐛 317 | 🌐 TypeScript | 📅 2026-09-03, [demo](https://demo.thelounge.chat/)) `JavaScript` `Node.js` `Web`
* [![WeeChat-icon](https://user-images.githubusercontent.com/15098724/56876389-e028f880-69fb-11e9-82d6-8084e17f2f04.png) WeeChat](https://weechat.org) - A fast, light and extensible chat client. ([source](https://github.com/weechat/weechat) ⭐ 3,374 | 🐛 439 | 🌐 C | 📅 2026-09-04) `Linux` `macOS`
...
* [Ergo](https://ergo.chat/) - Modern server that's portable and designed around specifications (bleeding-edge IRCv3 support). ([source](https://github.com/ergochat/ergo) ⭐ 3,317 | 🐛 202 | 🌐 Go | 📅 2026-09-01)
* [InspIRCd](https://www.inspircd.org) - Modular, stable, written from scratch. ([source](https://github.com/inspircd/inspircd) ⭐ 1,345 | 🐛 112 | 🌐 C++ | 📅 2026-09-04)
